...
* **The Workflow:**
    ...
    4.  **Submit to iStudy:** Save your answers as a file (e.g., Text, or photo of your handwritten responses). Upload that file to the iStudy App (link provided in the Table of Contents on the left sidebar). The app will provide feedback and generate a revised version of your responses for your records.
...
As students start to use the app, we have come across some Gmail issues you need to be aware of:

*Restricted Gmail account*: If your Gmail account does not display the option to get an API key, it is very likely your account has restrictions. You were a minor when you opened it, from a restricted country, or administrator restriciton (UH email does not work). Try a different account or create a new one. 
...
If you try and still fail, take a screenshot of the website where you hit a roadblock, paste it in [Gemini](https://gemini.google.com/) or [chatGPT](https://chatgpt.com), and write ***"Help me get a Google AI studio API key. I am stuck in the current page. What do I need to do next? Be brief and give me a solution I can do now"***
```
