...
*   **The Workflow:**
    1.  **Chapter Selection:** Navigate to the current week's chapter on this website. There are 13 chapters in the class, which are enumerated on the TOC on the left.
...
3.  **Generate the Key:**
    *   Click `Get API key` (bottom left button).
