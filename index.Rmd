...
### **Phase A: Submitting Weekly Essays** {-}

<span style="font-size: 0.8em;"> *Determines your grade up to a **B+**. Each week, by the end of Sunday, submit at least one essay. You are welcome to submit more if you wish to work ahead.*</span>
...
*   **The Workflow:**
    1.  **Chapter Selection:** Navigate to the current week's chapter on this website.
    2.  **Get Questions:** Click the **"Exam questions"** link to see what you need to answer.
    3.  **Watch & Answer:** Watch the lecture video. Your answers must come **exclusively** from the lecture content.
    4.  **Submit to iStudy:** Upload your file to the [iStudy App](https://camilo-mora.github.io/GEO309/istudy-weekly-essay-delivery-app.html). iStudy will give you feedback on your responses, and deliver a revised version of the responses for your records.
...
![](images/ExampleResponses.png){style="display: block; margin: 0 auto; width: 80%;"}
...
*Voluntary assignments to reach the **A territory** (A-, A, or A+). Due any time after you finish Phase A and before the last day of class.*
...
*   **The Workflow:**
    ...
    2.  **Record (One Video Per Chapter):**
        *   Each video must cover **all** questions for that chapter. You choose which chapters to record.
        *   **Format:** State the question clearly, then provide the response from memory.
...
*   **Delivery:**
    ...
    2.  **Email:** Send the URL links to Dr. Mora.
        ...
        *   **Email Body:** State clearly: "I want an [A/A+], so I am submitting [Number] videos showing my mastery of [Number] chapters."
